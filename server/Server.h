...
private:
    ...
    Server()
    {
        ...
        {
            std::cout << "Server is unable to listen new connections" << std::endl;
            exit (1);
        } else{
            std::cout << "Server is listening new connections" << std::endl;
        }
        ...
        if (connection == -1)
        {
            std::cout << "Server is unable accept the data from client" << std::endl;
            exit (1);
        }
    }
